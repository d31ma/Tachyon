...
## Corpus Check
- 50 files · ~47,679 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 478 nodes · 828 edges · 18 communities detected
...
- `expect()` --calls--> `expectInteractiveSurface()`  [INFERRED]
  scripts/verify-package-contract.js → tests/playwright/examples.e2e.js
- `handleDelegatedEvent()` --calls--> `getAttribute()`  [INFERRED]
  src/runtime/spa-renderer.js → tests/integration/api-routes.test.js
- `syncFormControlState()` --calls--> `getAttribute()`  [INFERRED]
  src/runtime/dom-helpers.js → tests/integration/api-routes.test.js

## Communities

### Community 0 - "Community 0"
Cohesion: 0.07
Nodes (3): runSelectiveBuild(), pathExists(), Tac

### Community 1 - "Community 1"
Cohesion: 0.06
Nodes (5): getPublicBrowserEnv(), splitList(), withPublicBrowserEnv(), decode(), Yon

### Community 2 - "Community 2"
Cohesion: 0.06
Nodes (23): authFetch(), authHeaders(), decodeAnyValue(), extractPersistedSpans(), getResourceAttribute(), waitForServer(), waitForTelemetrySpans(), constructor() (+15 more)
...
Cohesion: 0.13
Nodes (14): OpenAPI, basename(), Pool, tokenizeCommand(), configureRoutes(), detectAppShape(), directoryHasFiles(), isAssetRequest() (+6 more)
...
Cohesion: 0.18
Nodes (8): pathExists(), resolvePreviewFile(), serveStaticPreviewRequest(), shouldTreatAsAsset(), jsonResponse(), jsResponse(), staticRouteResponse(), typedResponse()

### Community 12 - "Community 12"
Cohesion: 0.2
Nodes (9): buildRouteOutput(), classifyChange(), normalizeRelative(), pathExists(), runBuild(), runWithConcurrency(), startBundleWatcher(), watchPaths() (+1 more)
...
- **Thin community `Community 13`** (7 nodes): `telemetry-alert-worker.js`, `TelemetryAlertWorker`, `.buildAlerts()`, `.constructor()`, `.fetchTelemetry()`, `.numberEnv()`, `.run()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 21`** (3 nodes): `createHelpers()`, `Fixture`, `tac.test.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `loadManifests()` connect `Community 2` to `Community 6`?**
  _High betweenness centrality (0.230) - this node is a cross-community bridge._
- **Why does `Tac` connect `Community 0` to `Community 1`, `Community 11`, `Community 12`, `Community 5`?**
