...
//! per identifier.
//!
//! The encoding matches the immutable v26.30.04 release contract:
//! `(milliseconds * 10_000)` encoded as uppercase base 36. One unit is
//! therefore 100 nanoseconds, which this module derives directly from the
//! clock instead of from a scaled millisecond float.
