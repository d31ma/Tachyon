...
fn application_globals() -> String {
    ...
    let source = include_str!("../../../src/types/globals.d.ts");
    let replacements = [
        ("typeof import(\"../runtime/tac.js\").default", "any"),
        ("import(\"../runtime/tac.js\").TacProps", "any"),
        ("typeof import(\"../runtime/decorators.js\").env", "any"),
        ("typeof import(\"../runtime/decorators.js\").onMount", "any"),
        ("typeof import(\"../runtime/decorators.js\").publish", "any"),
        (
            "typeof import(\"../runtime/decorators.js\").subscribe",
            "any",
        ),
        ("import(\"../runtime/tac.js\").TacPlatformContext", "any"),
    ];
    let mut standalone = String::from(source);
    for (pattern, replacement) in replacements {
        standalone = standalone.replace(pattern, replacement);
    }
    globals.push_str(&standalone);
    globals
}
